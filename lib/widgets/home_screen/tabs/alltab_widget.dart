...
class AllTabWidget extends StatefulWidget{

  @override
  State<AllTabWidget> createState() => _AllTabWidgetState();
}

class _AllTabWidgetState extends State<AllTabWidget> {
